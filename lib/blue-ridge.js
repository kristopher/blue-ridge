...
require(BLUE_RIDGE_LIB_PREFIX + "screw/screw-unit.js");
require(BLUE_RIDGE_LIB_PREFIX + "jquery/jquery-1.3.2.js");
require(BLUE_RIDGE_LIB_PREFIX + "jquery/jquery.fn.js");
require(BLUE_RIDGE_LIB_PREFIX + "jquery/jquery.print.js");
require(BLUE_RIDGE_LIB_PREFIX + "smoke/smoke.core.js");
require(BLUE_RIDGE_LIB_PREFIX + "smoke/smoke.mock.js");
require(BLUE_RIDGE_LIB_PREFIX + "smoke/smoke.stub.js");
require(BLUE_RIDGE_LIB_PREFIX + "screw/screw.mocking.js");
